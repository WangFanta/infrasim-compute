...
def run_cmd(cmd):
    ...
    while not stdout.channel.exit_status_ready():
        pass
    lines = stdout.channel.recv(40960)
    ssh.close()
    return lines
...
class test_disk_array_topo(unittest.TestCase):
    ...
    def test_scsi_devices_availability(self):
        ...
        """
        rst = run_cmd("lspci")
        self.assertIn("Serial Attached SCSI controller: PMC", rst, "SAS Controller not loaded!")
    ...
    def test_sas_chain(self):
        ...
        verify_link(wwn_exp0, 8, wwn_exp2, 8, 4)
